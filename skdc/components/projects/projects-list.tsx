...
const STATUS_STYLES: Record<ProjectStatus, { className: string }> = {
  DRAFT: { className: "bg-zinc-500/20 text-zinc-200 ring-zinc-400/30" },
  IN_REVIEW: { className: "bg-amber-500/20 text-amber-200 ring-amber-400/30" },
  APPROVED: { className: "bg-sky-500/20 text-sky-200 ring-sky-400/30" },
  IN_PRODUCTION: { className: "bg-violet-500/20 text-violet-200 ring-violet-400/30" },
  COMPLETED: { className: "bg-emerald-500/20 text-emerald-200 ring-emerald-400/30" },
  CANCELLED: { className: "bg-rose-500/20 text-rose-200 ring-rose-400/30" },
};
      ...
      <ProjectFormDialog
        ...
        trigger={
          <div>
            <EmptyState
              icon={FolderKanban}
              titleKey="empty.projects.title"
              descriptionKey="empty.projects.description"
              ctaLabelKey="empty.projects.cta"
              onCta={() => {}}
            />
          </div>
        }
